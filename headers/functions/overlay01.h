...
undefined4 BattleStateManager(struct battle_struct *param_1,undefined4 param_2,int param_3,int *param_4);
...
undefined4 BattleHandleLossFrameUpdate(struct battle_struct *param_1,undefined4 param_2,int param_3,int *param_4);
